...
u_mode   = "R"
u_periodC1 = c(1971, 2012) # default time frame
u_periodC2 = c(1991, 2012)
u_indepSensiVarsC1 = c("E_CIm", "E_CEx", "E_CP", 
                       "GDPpc", "P", "P_Ndep", "URB", 
                       "LEx", 
                       "E_CRes", "E_CSeInd", #"E_OC", "E_GC", "E_NC", "E_RenC", 
                       #"Elec_C", "Elec", "E_TotPeS", "E_TotFeC", "E_TotFeCpc", 
                       "EE")#, "EF", "CO2")
u_indepSensiVarsC2 = c("E_CC", "E_CCGDP", "E_CCP",
...
u_indepSensiVarsC2 = c("E_CIm", "E_CEx", "E_CP", 
                       "GDPpc",
                       "P", "P_Ndep", 
                       "URB", 
                       "LEx", 
                       ...
                       #"E_TotPeS", "E_TotFeC",
                       #"E_TotFeCpc")
# countries consistent with balanced panel and sensible variables (80)
# Config1
u_iso_sensiVarC1  = c("CHN","USA", "DEU", "IND", "JPN", "POL", "GBR", "ZAF", "FRA", "KOR", "TUR", "CAN", "AUS", "BEL", "ITA", "BRA", "ESP", "IDN",
...
# Config2
u_iso_sensiVarC2  = c("CHN", "DEU", "IND", "JPN", "GBR", "ZAF", "FRA", "KOR", "TUR", "AUS", "ITA", "BRA", "IDN",
             ...
             "SGP", "URY", "TZA", "BOL", "SLV")
u_iso_sensiVarC2  = c("CHN", "USA", "DEU", "IND", "JPN", "POL", "GBR", "ZAF", "FRA", "KOR", "TUR", "CAN", "AUS", "BEL", "ITA", "BRA", "ESP", "IDN",
                      "VNM", "THA", "ROU", "AUT", "BGR", "NLD", "PAK", "MEX", "COL", "SWE", "FIN", "ZWE", "NOR", "NZL", "DNK", "GRC", "PHL", 
                      "MYS", "CHL", "CHE", "EGY", "PER", "IRN", "ARG", "BGD", "MAR", "DZA",
                      "COD", "KEN", "MOZ", "DOM", "NGA", "HND", "TUN", "SEN", "PAN", "CYP", "LKA", "MUS", "JOR", "CRI", 
                      "SGP", "URY", "TZA", "BOL", "SLV")
...
defineCases  <- function() {list(
  #===== Config1 ================================================================================
  #===== E_CC  ==================================================================================
  "testingMethods2 - OLS - SensiVarsC1 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
    demean    = FALSE,
    firstdiff = FALSE,
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
  ...
  "testingMethods2 - First-differences - SensiVarsC1 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
    ...
    firstdiff = TRUE,
    treetype  = "Single tree > LMS - Multilinear",
    maxsplits = 7, minnbnodes = 1,
    cex       = 0.5, legend.cex = 1.0
  ),
  #===== E_CCGDP ================================================================================
  "testingMethods2 - OLS - SensiVarsC1 - E_CCGDP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCGDP",
    demean    = FALSE,
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CCGDP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCGDP",
  ...
  "testingMethods2 - First-differences - SensiVarsC1 - E_CCGDP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCGDP",
    ...
    firstdiff = TRUE,
    treetype  = "Single tree > LMS - Multilinear",
    maxsplits = 6, minnbnodes = 1,
    cex       = 0.5, legend.cex = 1.0
  ),
  #===== E_CCP ================================================================================
  "testingMethods2 - OLS - SensiVarsC1 - E_CCP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCP", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCP",
    demean    = FALSE,
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CCP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCP", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCP",
  ...
  "testingMethods2 - First-differences - SensiVarsC1 - E_CCP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCP", n=u_indepSensiVarsC1),
    period    = u_periodC1,
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCP",
  ...
  #===== Config2 ================================================================================
  #===== E_CC  ==================================================================================
  "testingMethods2 - OLS - SensiVars-C2 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC2),
    period    = u_periodC2,
    iso       = u_iso_sensiVarC2,
    dvar      = "E_CC",
    demean    = FALSE,
    firstdiff = FALSE,
    treetype  = "Single tree > LMS - Multilinear", 
  ...
  "testingMethods2 - Fixed effects - SensiVarsC2 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC2),
    period    = u_periodC2,
    iso       = u_iso_sensiVarC2,
    dvar      = "E_CC",
  ...
  "testingMethods2 - First-differences - SensiVarsC2 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC2),
    period    = u_periodC2,
    iso       = u_iso_sensiVarC2,
    dvar      = "E_CC",
  ...
  #===== E_CCGDP ================================================================================
  "testingMethods2 - OLS - SensiVarsC2 - E_CCGDP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC2),
    period    = u_periodC2,
    iso       = u_iso_sensiVarC2,
    dvar      = "E_CCGDP",
    demean    = FALSE,
  ...
  "testingMethods2 - Fixed effects - SensiVarsC2 - E_CCGDP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC2),
    period    = u_periodC2,
    iso       = u_iso_sensiVarC2,
    dvar      = "E_CCGDP",
  ...
  "testingMethods2 - First-differences - SensiVarsC2 - E_CCGDP" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC2),
    period    = u_periodC2,
    iso       = u_iso_sensiVarC2,
    dvar      = "E_CCGDP",
  ...
  #===== Clark2012 ================================================================================
  "testingMethods2 - OLS - Clark2012 - E_CC" = list(
    ...
    firstdiff = FALSE,
    treetype  = "Single tree > LMS - Multilinear",
    maxsplits = 4, minnbnodes = 3,
    cex       = 0.3, legend.cex = 1.5
  ),
  "testingMethods2 - Fixed effects - Clark2012 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex")),
    period    = c(1990,2012),
    iso       = u_iso_clark2012,
    dvar      = "E_CC",
  ...
  "testingMethods2 - First-differences - Clark2012 - E_CC" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex")),
    period    = c(1990,2012),
    iso       = u_iso_clark2012,
    dvar      = "E_CC",
    ...
    firstdiff = TRUE,
    treetype  = "Single tree > LMS - Multilinear",
    maxsplits = 12, minnbnodes = 1,
    cex       = 0.5, legend.cex = 1.0
  ),
  #===== Clark2012 (extended) ================================================================================
  "testingMethods2 - OLS - Clark2012 - E_CC - Extended-s" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex"), 
                                            s=c("E_CIm", "E_CEx", "E_CP", "GDP",
                                                "LEx", "E_CRes", "E_CSeInd", "E_OC", "E_GC", "E_NC", "E_RenC", 
                                                "Elec_C", "Elec", "E_TotPeS", "E_TotFeC", "E_TotFeCpc", "EE", "EF", "CO2")),
    period    = c(1990,2012),
    iso       = u_iso_clark2012,
    dvar      = "E_CC",
  ...
  "testingMethods2 - Fixed effects - Clark2012 - E_CC - Extended-s" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex"), 
                                            s=c("E_CIm", "E_CEx", "E_CP", "GDP",
                                                "LEx", "E_CRes", "E_CSeInd", "E_OC", "E_GC", "E_NC", "E_RenC", 
                                                "Elec_C", "Elec", "E_TotPeS", "E_TotFeC", "E_TotFeCpc", "EE", "EF", "CO2")),
  ...
  "testingMethods2 - First-differences - Clark2012 - E_CC - Extended-s" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex"), 
                                            s=c("E_CIm", "E_CEx", "E_CP", "GDP",
                                                "LEx", "E_CRes", "E_CSeInd", "E_OC", "E_GC", "E_NC", "E_RenC", 
                                                "Elec_C", "Elec", "E_TotPeS", "E_TotFeC", "E_TotFeCpc", "EE", "EF", "CO2")),
  ...
  "testingMethods2 - OLS - SensiVarsC1 - E_CC -sp1y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = c(1972,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
  ...
  "testingMethods2 - OLS - SensiVarsC1 - E_CC -sp2y" = list(
  vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
  period    = c(1973,2012),
  iso       = u_iso_sensiVarC1,
  dvar      = "E_CC",
  ...
  "testingMethods2 - OLS - SensiVarsC1 - E_CC -sp3y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = c(1974,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CC -sp1y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = c(1972,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CC -sp2y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = c(1973,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CC -sp3y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=u_indepSensiVarsC1),
    period    = c(1974,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CC",
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CCGDP -sp1y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC1),
    period    = c(1972,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCGDP",
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CCGDP -sp2y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC1),
    period    = c(1973,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCGDP",
  ...
  "testingMethods2 - Fixed effects - SensiVarsC1 - E_CCGDP -sp3y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CCGDP", n=u_indepSensiVarsC1),
    period    = c(1974,2012),
    iso       = u_iso_sensiVarC1,
    dvar      = "E_CCGDP",
  ...
  "testingMethods2 - Fixed effects - Clark2012 - E_CC -sp1y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex")),
    period    = c(1991,2012),
    iso       = u_iso_clark2012,
    dvar      = "E_CC",
  ...
  "testingMethods2 - Fixed effects - Clark2012 - E_CC -sp2y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex")),
    period    = c(1992,2012),
    iso       = u_iso_clark2012,
    dvar      = "E_CC",
  ...
  "testingMethods2 - Fixed effects - Clark2012 - E_CC -sp3y" = list(
    vardef    = generate_variableDefinition(v_dataShort, d="E_CC", n=c("GDPpc", "P","P_Ndep","URB","ManuGDP","Manu_Ex")),
    period    = c(1993,2012),
    iso       = u_iso_clark2012,
    dvar      = "E_CC",
...
#==== Run experiments ===================
for (k_case in names(u_cases)[3:length(u_cases)]) {
  
  print(paste0("Experiment ", k_case))
  
  # Initialise GUIDE file paths and tree options
  outPath  <- file.path("output/testingMethods2/RT models", k_case)
...
#save(u_cases, v_data, v_tree, v_alloc, v_regdata, file = file.path("output/testingMethods2/data", paste0("testing_methods2_", format(Sys.time(), "%Y-%m-%d"),".RData")))
load(file.path("output/testingMethods2/data", paste0("testing_methods2_", format(Sys.time(), "%Y-%m-%d"),".RData")))
  ...
  if (!is.null(v_tree[[k_case]])) {
    ...
    if (dim(tree$frame)[1] != 0) {
      plot_tree(tree, 
                ...
                FILENAME = file.path("output/testingMethods2/Plots Trees/", paste0(k_case, ".pdf")))
      plot_tree(tree, 
                TITLE=paste0("RT - ", k_case, "\nLMS-Multilinear - Tn:", length(which(v_tree[[k_case]]$nodeType == "Terminal node")), "\n#Countries: ",length(unique(v_data[[k_case]]$data$iso)), " - period: ",min(v_data[[k_case]]$data$year),"-",max(v_data[[k_case]]$data$year)), 
                CEX=NULL, LEGEND.X = 0, LEGEND.Y = 1.1, LEGEND.CEX=0.5, LEGEND.NCOL=2,
                FILENAME = file.path("output/testingMethods2/Plots Trees/", paste0(k_case, ".png")))
    }
    
    if (dim(v_alloc[[k_case]])[1] != 0) {
      # Country pathways
      png(filename=file.path("output/testingMethods2/Plots country pathways/", paste0(k_case, ".png")), width=1500, height=1500)
      ...
      #print(p)
      ggsave(filename = file.path("output/testingMethods2/Pred Plots/", paste0(k_case, ".png")), width = 297, height = 210, units = c("mm"), dpi = 300)
    }
  }
}
...
ggplot(m_rel) + 
  ...
  ggtitle(paste0("Misallocation (%): ", round((m_abs %>% group_by(TN_T1) %>% filter(value != max(value)) %>% summarise(sum=sum(value)) %>% ungroup() %>% summarise(sum=sum(sum)))$sum/sum(m_abs$value)*100, digits=1)))
